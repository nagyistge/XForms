...
namespace Xamarin.Forms.Platform.Mac
{
  public class EventTracker : IDisposable
  {
    ...
    public void LoadEvents(UIView handler)
    {
      ...
      this.OnElementChanged((object) this, new VisualElementChangedEventArgs((VisualElement) null, this.renderer.Element));
    }
    ...
    protected virtual UIGestureRecognizer GetNativeRecognizer(IGestureRecognizer recognizer)
    {
      ...
      WeakReference weakRecognizer = new WeakReference((object) recognizer);
      WeakReference weakEventTracker = new WeakReference((object) this);
      ...
      return (UIGestureRecognizer) this.CreatePinchRecognizer((Action<UIPinchGestureRecognizer>) (r =>
      {
        ...
        // ISSUE: reference to a compiler-generated method
        // ISSUE: reference to a compiler-generated method
        CGPoint cgPoint = UIApplication.SharedApplication.KeyWindow.ConvertPointToView(r.LocationInView((UIView) null), eventTracker.renderer.NativeView);
