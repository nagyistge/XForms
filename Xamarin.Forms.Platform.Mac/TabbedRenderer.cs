...
{
	public class TabbedRenderer : NSViewController, IVisualElementRenderer, IDisposable, IRegisterable
	{
		private bool loaded;
		...
		public override NSViewController SelectedViewController
		{
			get
			{
		...
		*/
		...
		public void SetElement (VisualElement element)
		{
			...
			this.OnPagesChanged (null, new NotifyCollectionChangedEventArgs (NotifyCollectionChangedAction.Reset));
			if (element != null)
