...
namespace Xamarin.Forms.Platform.Mac
{
	...
	{
		public static void ApplyKeyboard (this NSTextField textInput, Keyboard keyboard)
		{
		...
		/*
		 * No supported in OSX
		internal static DeviceOrientation ToDeviceOrientation (this NSDeviceOrientation orientation)
		{
